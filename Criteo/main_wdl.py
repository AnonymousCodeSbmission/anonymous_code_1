...
from custom_gradients_masking import no_noise, gradient_masking, gradient_gaussian_noise_masking_function_creator, KL_gradient_perturb_function_creator
...
parser.add_argument("--train_file", type=str,
                    default="../data/criteo/new_train_0.9.csv",
                    help="directory of the dataset for training")
parser.add_argument("--test_file", type=str,
                    default="../data/criteo/new_test_0.1.csv",
...
parser.add_argument(
  ...
  type=int,
  default=[128, 128, 128, -1, 128, 128, 128],  # default if nothing is provided
)
...
with open('../data/vocab_size.pkl', 'rb') as file:
...
if args.noise_layer_function == 'expectation':
