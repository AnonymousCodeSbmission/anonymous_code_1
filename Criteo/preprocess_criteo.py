...
train_data.to_csv(path_or_buf=os.path.join(data_directory, 'new_train_0.9.csv'), index=False)
test_data.to_csv(path_or_buf=os.path.join(data_directory, 'new_test_0.1.csv'), index=False)